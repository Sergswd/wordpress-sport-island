...
class SI_Widget_Info extends WP_Widget{
  public function __construct() {
    parent::__construct(
      'si_widget_info',
      'FitnessMedic - Информация',
      [
        'name' => 'FitnessMedic - Информация',
        'description' => 'Выводит информацию о спорт-клубе. Основное использование - на странице контактов, под картой'
      ]
    );
  }
